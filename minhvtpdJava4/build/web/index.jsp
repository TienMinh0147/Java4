            ...
            <div id="top-header">
                <div class="container">
                    <ul class="header-links pull-left">
                        <li><a href="#"><i class="fa fa-phone"></i> 0000000000000</a></li>
                        <li><a href="#"><i class="fa fa-envelope-o"></i> minhvtpd02930@fpt.edu.vn</a></li>
                        <li><a href="#"><i class="fa fa-map-marker"></i> 137 Nguyen Thi Thap</a></li>
                    </ul>
                        ...
                        <div class="col-md-3">
                            <div class="header-logo">
                                <a href="index.jsp" class="logo">
                                    <strong> <h2>ĐIỆN THOẠI TIÊN MINH</h2></strong>
                                </a>
                            </div>
                        </div>
                        <!-- /LOGO -->
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li><a href="admin/index.jsp">Liên hệ</a></li>
                    </ul>
                    <!-- /NAV -->
                </div>
                <!-- /responsive-nav -->
